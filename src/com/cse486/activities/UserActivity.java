...
import com.cse486.R;
import com.cse486.adapters.ChatListAdapter;
import com.cse486.chat.Chat;

public class UserActivity extends ListActivity {
	private Firebase ref;
	private String url = "https://gurayansin.firebaseio.com/";
	public String key;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		chatListAdapter = new ChatListAdapter(
				ref.child(key).endAt().limit(100), this, R.layout.list_chat,
				myNo);
		lv.setAdapter(chatListAdapter);
		lv.setTranscriptMode(ListView.TRANSCRIPT_MODE_ALWAYS_SCROLL);
		lv.setStackFromBottom(true);

		connectedListener = ref.getRoot().child(".info/connected")
				.addValueEventListener(new ValueEventListener() {
					...
					public void onCancelled(FirebaseError arg0) {
						...
						Toast.makeText(getApplicationContext(),
								"Failed. Try Again!", Toast.LENGTH_SHORT)
								.show();

					}
				});

		ref.getRoot().child(".info/connected")
